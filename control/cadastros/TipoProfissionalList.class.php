...
class TipoProfissionalList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addAction( "Novo", new TAction( [ "TipoProfissionalForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $action_edit = new TDataGridAction( [ "TipoProfissionalForm", "onEdit" ] );
    ...
    public function onReload( $param = NULL )
    {
        try {
            ...
            $repository = new TRepository( "TipoProfissionalRecord" );
